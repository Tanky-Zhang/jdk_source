...
public class HelloServer {
    ...
    private Selector getSelector(int port) throws IOException {
        ...
        //将该通道绑定到Selector，并为该通道注册SelectionKey.OP_ACCEPT事件(可连接事件监听)
...
//            }
    ...
    private void process(SelectionKey key) throws IOException {
        if (key.isAcceptable()) { // 接收请求
            ...
            if (channel == null) {
                System.out.println("thread accept fail " + Thread.currentThread().getName());
                return;
            }
            //设置非阻塞模式
            ...
            System.out.println("thread accept success " + Thread.currentThread().getName());
        }
